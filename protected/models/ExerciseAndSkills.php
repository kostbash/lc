...
/**
 * This is the model class for table "oed_exercise_and_skills".
 *
 * The followings are the available columns in table 'oed_exercise_and_skills':
 * @property integer $id
 * @property integer $id_exercise
 * @property integer $id_skill
 */
class ExerciseAndSkills extends CActiveRecord
{
	/**
	...
	{
		return 'oed_exercise_and_skills';
	}
	 ...
	 * @return ExerciseAndSkills the static model class
	 */
