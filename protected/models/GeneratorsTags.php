...
/**
 * This is the model class for table "oed_generators_tags".
 *
 * The followings are the available columns in table 'oed_generators_tags':
 * @property integer $id
 * @property integer $id_dictionary
 * @property string $name
 */
class GeneratorsTags extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_dictionary, name', 'required'),
			array('id_dictionary', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_dictionary, name', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return GeneratorsTags the static model class
	 */
