...
class CourseYougetsController extends Controller
{
	/**
	...
	public function accessRules()
	{
        ...
        public function actionCreate($id_course)
        {
            ...
            {
                if($_POST['CourseYougets'])
                {
                    $model = new CourseYougets;
                    $model->name = $_POST['CourseYougets']['name'];
        ...
        public function actionUpdate()
        {
            ...
            if($_POST['CourseYougets'])
            {
                foreach($_POST['CourseYougets'] as $id => $attributes)
                {
	...
	{
            $model = CourseYougets::model()->findByPk($id);
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='course-yougets-form')
		{
