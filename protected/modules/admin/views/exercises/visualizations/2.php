<div class="row">
    ...
    <div class="col-lg-5 col-md-5">
        <?php echo CHtml::dropDownList('Exercises[correct_answers]', $model->correct_answers, array(), array('class'=>'form-control', 'placeholder'=>'Введите правильный ответ', 'size'=>2)); ?>
    </div>
