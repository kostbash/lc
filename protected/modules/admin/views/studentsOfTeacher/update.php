<div class="page-header clearfix">
    <h2>Настройки ученика "<?php echo $cloneModel->student_name." ".$cloneModel->student_surname; ?>"</h2>
    <?php echo CHtml::link('<i class="glyphicon glyphicon-ok"></i>Сохранить', '#', array('class'=>'btn btn-success btn-icon', 'onclick'=>'$("#students-of-teacher-form").submit();')); ?>
</div>
<div class="form">
