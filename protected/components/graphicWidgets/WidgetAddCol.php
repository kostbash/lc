...
//            {
//                $subtrahend = (int) ($mul1+$mul2); // вычитаемое
//                
...
//            }
    ...
    {//print "COUNT=";print_r(count($answers));
        ...
        for($i = 0;$i<strlen($value);$i++)
        {
            ...
            {
                //print '['.$key."]=".(isset($answers[$key])?"1":"0")."<br>";
...
//                    {
//                        $this->values['subs'][$match[1]-1]['subtrahend'] = $this->setPartialInput($this->values['subs'][$match[1]-1]['subtrahend'], $inp,$numberOfExercise,&$answers,&$key);;
//                        
//                    }
//                }
            }
