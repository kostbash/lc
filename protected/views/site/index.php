            ...
            <div id="header-top">
                ...
                <div id="login">
                    <div id="logining" class="clearfix">
                        ...
                        <div class="login-button" data-toggle="modal" data-target="#loginForm"><a href="#">Войдите</a></div>
                    </div>
                    <div class="clearfix" id="top-menu-on-main">
                        <ul>
            ...
            <ul class="nav nav-tabs">
                <li class="active">
                    <div href="#panel-1" data-toggle="tab" class="tab-header">
                        ...
                        <img class="course-icon" src="images/math-icon2.png" />
                        <div class="name">
                            <h3>Математика</h3>
                        </div>
                    </div>
                ...
                <li>
                    <div href="#panel-2" data-toggle="tab" class="tab-header">
                        ...
                        <img class="course-icon" src="images/english-icon2.png" />
                        <div class="name">
